...
public class GeneticAlgorithm {
	...
	public List<cloudlet3> cloudletList;
	public List<vm3> vmlist;
	...
	public double calcFitness(Individual individual) {
		...
		for (int geneIndex = 0; geneIndex < individual.getChromosomeLength(); geneIndex++) {
			...
			cost= cost + executionCostArray[individual.chromosome[geneIndex]];
		}
		//communication cost
...
//			cost = cost + cloudletList.get(individual.chromosome[geneIndex]]).comcost[individual[geneIndex-1]]*vmlist[geneIndex].datasize[0];
			...
			cost += data[0]*communicationCostArray[individual.chromosome[geneIndex-1]];
		}
